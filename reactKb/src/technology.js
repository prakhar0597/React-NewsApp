...
class technologyExample extends Component {
    constructor() {
        super()
    ...
    componentDidMount() {
        ...
        const url_g = 'https://csci571-nodejs-backend.wl.r.appspot.com/technology/';
        axios.get(url_g).then(response => response.data)
            .then((data) => {
                this.setState({ users: data, isLoading: false  })
                //console.log(this.state.users);
            })
        const url_ny = 'https://csci571-nodejs-backend.wl.r.appspot.com/n_technology/';
...
export default technologyExample;